...
class ScreenRegisterStepOne extends StatefulWidget {
  const ScreenRegisterStepOne({super.key});

  @override
  State<ScreenRegisterStepOne> createState() => _ScreenRegisterStepOneState();
}

class _ScreenRegisterStepOneState extends State<ScreenRegisterStepOne> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 30),
                    Text(
                            'Ingresa Documento del paciente',
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
